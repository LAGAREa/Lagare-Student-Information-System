                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                Number of Enrollments</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $enrollmentCount }}</div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                Number of Grades</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $gradeCount }}</div>
                        </div>
                        <div class="col-auto">
